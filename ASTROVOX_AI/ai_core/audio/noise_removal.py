...
class NoiseRemover:
    ...
    def _spectral_gate(self, input_path: str, output_path: str, strength: float) -> None:
        ...
        data, sr = AudioUtils.load_audio(input_path)
        ...
        AudioUtils.save_audio(output_path, x_clean, sr)
    ...
    def _demucs_remove(self, input_path: str, output_path: str) -> None:
        try:
            ...
            out = separate_audio(model, input_path, output_dir=Path(output_path).parent, split=True)
