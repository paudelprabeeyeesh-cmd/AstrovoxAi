"""Multilingual tokenizer with script detection and language-specific rules."""
...
_LANGUAGE_ABBREVIATIONS: Set[str] = {
    "en", "es", "fr", "de", "it", "pt", "nl", "pl", "tr", "vi", "id", "cs", "sv", "da", "no", "fi"
}
