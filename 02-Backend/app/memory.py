...
async def extract_memory_from_conversation(conversation_id: int, authorization: str = Header(None)):
    ...
    try:
        ...
        for msg in messages:
            ...
            if msg["role"] == "assistant":
                important_keywords = ["important", "remember", "note", "key", "critical", "must", "should"]
    ...
    try:
        ...
        response = client.chat.completions.create(
            ...
            messages=[
                {
                    "role": "system",
                    "content": "Extract the most important facts, preferences, and information from this conversation that should be remembered for future interactions. Return as a bullet list."
                },
                {
                    "role": "user",
