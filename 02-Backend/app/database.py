...
TABLES_SQL = """
CREATE TABLE IF NOT EXISTS users (id TEXT PRIMARY KEY, email TEXT UNIQUE, password_hash TEXT NOT NULL, role TEXT DEFAULT 'user', email_verified INTEGER DEFAULT 0, plan TEXT DEFAULT 'free', stripe_customer_id TEXT, created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP);
CREATE TABLE IF NOT EXISTS login_attempts (id TEXT PRIMARY KEY, ip TEXT NOT NULL, success INTEGER DEFAULT 0, lockout_until TEXT, created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP);
...
CREATE TABLE IF NOT EXISTS ipo_metrics (id TEXT PRIMARY KEY, user_id TEXT NOT NULL, name TEXT NOT NULL, target TEXT NOT NULL, current TEXT NOT NULL, created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP);
...
CREATE TABLE IF NOT EXISTS posts (id TEXT PRIMARY KEY, user_id TEXT NOT NULL, title TEXT NOT NULL, content TEXT NOT NULL, author TEXT DEFAULT 'founder', created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP);
...
CREATE TABLE IF NOT EXISTS amas (id TEXT PRIMARY KEY, user_id TEXT NOT NULL, title TEXT NOT NULL, description TEXT, scheduled_at TEXT NOT NULL, created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP);
...
CREATE TABLE IF NOT EXISTS ad_campaigns (id TEXT PRIMARY KEY, user_id TEXT NOT NULL, name TEXT NOT NULL, platform TEXT NOT NULL, budget REAL NOT NULL, start_date TEXT NOT NULL, end_date TEXT NOT NULL, created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP);
...
CREATE TABLE IF NOT EXISTS enterprise_accounts (id TEXT PRIMARY KEY, user_id TEXT NOT NULL, company TEXT NOT NULL, contact_email TEXT NOT NULL, plan TEXT DEFAULT 'enterprise', created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP);
