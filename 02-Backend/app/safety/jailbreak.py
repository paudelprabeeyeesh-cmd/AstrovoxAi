...
class JailbreakDetector:
    ...
    def __init__(self):
        self._compiled = [(re.compile(p, re.IGNORECASE), cat, sev) for p, cat, sev in self.PATTERNS]
...
class JailbreakMitigator:
    """Mitigate jailbreak attempts with adaptive responses."""
    ...
    def mitigate(self, text: str, user_id: Optional[str] = None) -> dict:
        ...
        blocked = action in ("block_request", "block_request_log", "block_request_alert")
